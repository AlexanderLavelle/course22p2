...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'miniai.accel': { 'miniai.accel.AccelerateCB': ('ddpm_v2.html#acceleratecb', 'miniai/accel.py'),
            ...
            'miniai.conv': {'miniai.conv.conv': ('convolutions.html#conv', 'miniai/conv.py')},
            ...
            'miniai.stability': {},
            'miniai.training': { 'miniai.training.accuracy': ('minibatch_training.html#accuracy', 'miniai/training.py'),
